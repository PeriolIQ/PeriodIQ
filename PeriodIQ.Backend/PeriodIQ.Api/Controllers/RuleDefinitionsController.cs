...
public class RuleDefinitionsController : ControllerBase
{
    ...
    public RuleDefinitionsController(RuleDefinitionService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] RuleDefinition item)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(string id, [FromBody] RuleDefinition item)
    {
